...
namespace Com.StellmanGreene.PubMed.Unit_Tests
{
    ...
    public class TestEnvironment
    {
        ...
        public void CheckDSN()
        {
            ...
            Assert.IsTrue(DSNs.Contains("Publication Harvester Unit Test"), "The unit tests require an ODBC DSN called 'Publication Harvester Unit Test' that points to a MySQL 8.0 database");
        }
