...
namespace Com.StellmanGreene.SocialNetworking
{
    ...
    public class TestEnvironment
    {
        ...
        public void CheckDSN()
        {
            ...
            Assert.IsTrue(DSNs.Contains("Social Networking Unit Test"), "The unit tests require an ODBC DSN called 'Social Networking Unit Test' that points to a MySQL 5.1 database");
        }


        /// <summary>
        /// Verify that the "Social Networking Unit Test" DSN points to a MySQL 5.1 database
        /// </summary>
        [Test]
